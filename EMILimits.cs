...
namespace EMIEMC_Viewer
{
    ...
    class EMILimits
    {
        ...
        public static List<IndvLimit> LimitList = new List<IndvLimit>
        {
            ...
            new IndvLimit() {   name="CISPR 32 Class B - 150 kHz to 30 MHz - QP", startfreq = 150000, unit = "dBµV", detector = Detector.QPeak,
                                AxisLabelLogFreq = new List<double>() { 0.15, 0.5, 1, 3, 10, 30 },
            ...
            new IndvLimit() {   name="CISPR 32 Class B - 150 kHz to 30 MHz - AVG", startfreq = 150000, unit = "dBµV", detector = Detector.Average,
                                AxisLabelLogFreq = new List<double>() { 0.15, 0.5, 1, 3, 10, 30 },
            ...
            new IndvLimit() {   name="CISPR 32 Class B - 30 MHz to 1 GHz (3m)", startfreq = 30000000, unit = "dBµV/m",
                                AxisLabelLogFreq = new List<double>() { 30, 50, 100, 200, 300, 500, 1000 },
            ...
            new IndvLimit() {   name="CISPR 32 Class B - 1 GHz to 6 GHz (3m)", startfreq = 1000000000, unit = "dBµV/m",
                                AxisLabelLogFreq = new List<double>() { 1000, 2000, 3000, 4000, 5000, 6000 },
    ...
    public class IndvLimit
    {
        ...
        public List<double> AxisLabelLogFreq { get; set; }
